...
execute join(['function! vital#_gh#Data#Base64#Base64#import() abort', printf("return map({'b64encode': '', 'b64decode': ''}, \"vital#_gh#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
